...
public class MouseRotation : MonoBehaviour
{
    ...
    private void Update ()
    {
        ...
        else if (rotationAxis == RotationAxis.X)
        {
            ...
            transform.localEulerAngles = new Vector3(transform.localEulerAngles.x, rotationX, 0.0f);
        }
        else
        {
            rotationY += Input.GetAxis("Mouse Y") * sensitivityY;
            ...
            transform.localEulerAngles = new Vector3(-rotationY, transform.localEulerAngles.y, 0.0f);
        }
    }
}